...
const Loading = () => {
  ...
  return (
    ...
    <div className='skeleton-text skeleton' style={{ height: '1.2rem', width: '20%', }}></div>
    <div className='skeleton-text skeleton' style={{ height: '1rem', width: '10%' }}></div>
    <div className='skeleton-text skeleton' style={{ height: '1rem', width: '40%' }}></div>
