...
const HamburgerMenu: React.FC = () => {
  ...
  return (
    <>
      ...
      <div style={{marginLeft:'0px !important'}} className={`fixed top-0 left-0 w-2/3 h-full bg-white  z-50  transition-transform duration-300 transform ${isOpen ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'}`}>
